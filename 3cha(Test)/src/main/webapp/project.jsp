...
<body>
  <%@include file="./common/include/header.jsp" %>
    <section>
        <dl class="conTit">
            <dt>COMPANY</dt>
            <dd>회사현황판을 한눈에 확인할 수 있습니다.</dd>
        </dl>
        <div class="confirmTabMenu">
            <!--탭 메뉴 영역-->
            <ul class="tabs">
                <li class="active"><a href="#tab1">회사전체</a></li>
                <li><a href="#tab2">프로젝트 추가하기</a></li>
                <li><a href="#tab3">프로젝트</a></li>
                <li><a href="#tab4">최종승인대기</a></li>
            </ul>
            <!--탭 내역-->
