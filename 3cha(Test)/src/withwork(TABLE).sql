...
INSERT INTO PROJECT(P_NUM, C_NUM, p_NAME, P_CONTENT, P_PERSON, P_DEADLINE, P_COUNTRY, P_TOTAL, P_STAT, P_SUZU, P_BARZU)
VALUES (PROJECT_SEQ.NEXTVAL, 15, '인공지능', 'AI/음성인식 프로그램 개발', '개발3/디자인1', '4개월', '국내', '50,000,000', '검토', '디지토피아', '미라콤 아이앤씨');
INSERT INTO PROJECT(P_NUM, C_NUM, p_NAME, P_CONTENT, P_PERSON, P_DEADLINE, P_COUNTRY, P_TOTAL, P_STAT, P_SUZU, P_BARZU)
VALUES (PROJECT_SEQ.NEXTVAL, 15, 'MES', '공정관리프로그램 개발', '개발3/디자인1', '4개월','국내', '50,000,000', '검토', '이원정보기술', '미라콤 아이앤씨');
INSERT INTO PROJECT(P_NUM, C_NUM, p_NAME, P_CONTENT, P_PERSON, P_DEADLINE, P_COUNTRY, P_TOTAL, P_STAT, P_SUZU, P_BARZU)
VALUES (PROJECT_SEQ.NEXTVAL, 15, 'CRM', '고객관리 프로그램 개발', '개발3/디자인1', '4개월', '국내', '50,000,000', '검토', '일진', '미라콤 아이앤씨');
COMMIT;


INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 15, '기획(AE,MP)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 15, '제작(CD/CW/PD, 디자이너');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 15, '개발(개발자)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 15, '경영지원(인사/총무/회계)');

INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 16, '기획(AE,MP)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 16, '제작(CD/CW/PD, 디자이너');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 16, '개발(개발자)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 16, '경영지원(인사/총무/회계)');

INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 17, '기획(AE,MP)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 17, '제작(CD/CW/PD, 디자이너');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 17, '개발(개발자)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 17, '경영지원(인사/총무/회계)');

INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 18, '기획(AE,MP)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 18, '제작(CD/CW/PD, 디자이너');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 18, '개발(개발자)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 18, '경영지원(인사/총무/회계)');


INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 19, '기획(AE,MP)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 19, '제작(CD/CW/PD, 디자이너');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 19, '개발(개발자)');
INSERT INTO DEPARTMENT VALUES(DEPARTMENT_SEQ.NEXTVAL, 19, '경영지원(인사/총무/회계)');
COMMIT;
