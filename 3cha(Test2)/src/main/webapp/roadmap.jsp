            ...
            <dd>
                <div class="table workDetail">
                    <table>
                        ...
                        <tr>
                            <th>내용</th>
                            <td colspan="3"><i nput type="text" style="width :100%" /></td>
                        </tr>
                        <tr>
                            <th>담당자</th>
                            <td colspan="3"><input type="text" style="width :100%" /></td>
                        ...
                        <tr>
                            ...
                            <th>국내/해외</th>
                            <td colspan="1">
							<input type="checkbox" name="chk_info" value="국내">국내
							<input type="checkbox" name="chk_info" value="해외" checked="checked">해외
                            </td>
                        </tr>
