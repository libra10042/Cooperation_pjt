...
(
    ...
    G_NO         NUMBER            NULL, 
    ORG_NAME     VARCHAR2(1000)    NULL, 
    SAV_NAME     VARCHAR2(1000)    NULL, 
    FILE_SIZE    NUMBER            NULL, 
    F_REGDATE    SYSDATE           NULL, 
    DEL_GB       VARCHAR2(1)       NULL, 
    CONSTRAINT FILE_PK PRIMARY KEY (F_NO)
)
/
...
COMMENT ON COLUMN FILE.F_NO IS 'FILE.NO'
/

COMMENT ON COLUMN FILE.G_NO IS 'GUEST.NO'
/

COMMENT ON COLUMN FILE.ORG_NAME IS '원본파일이름'
/

COMMENT ON COLUMN FILE.SAV_NAME IS '변경된파일이름'
/

COMMENT ON COLUMN FILE.FILE_SIZE IS '파일크기'
/

COMMENT ON COLUMN FILE.F_REGDATE IS '파일등록일'
/

COMMENT ON COLUMN FILE.DEL_GB IS '삭제구분'
/

ALTER TABLE FILE
    ADD CONSTRAINT FK_FILE_G_NO_GUEST_G_NUM FOREIGN KEY (G_NO)
        REFERENCES GUEST (G_NUM)
/
...
COMMENT ON COLUMN PROJECT.ORG_NAME IS '요구사항분석 및 계획 문서'
/
...
ALTER TABLE PROJECT
    ADD CONSTRAINT FK_PROJECT_ORG_NAME_FILE_ORG_N FOREIGN KEY (ORG_NAME)
        REFERENCES FILE (ORG_NAME)
/
