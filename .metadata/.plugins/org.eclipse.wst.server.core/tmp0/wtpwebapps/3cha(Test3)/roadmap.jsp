...
/*
			...
			$(".sendBtnP").click(function(event) {
				...
				$.ajax({
					...
					data : {
						...
						p_person : $("#p_person").val(),
						p_deadline : $("#p_deadline").val(),
	...
	*/	 
	...
	<!-- ------- 프로젝트 생성 팝업 -------- -->
	<form action="insertProject.do" method="post" enctype="multipart/form-data">
						...
						<table>
							...
							<tr>
								...
								<td colspan="3"><input type="text" style="width: 100%"
									name="p_name" id="p_name" /></td>
							</tr>
							<tr>
								<th>내용</th>
								<td colspan="3"><input type="text" style="width: 100%"
									name="p_content" id="p_content" /></td>
							</tr>
							<tr>
								<th>담당자</th>
							...
							<tr>
								<th>인력구성</th>
								<td colspan="3"><input type="text" style="width: 100%"
									name="p_person" id="p_person" /></td>
							</tr>

							<tr>
								<th>수주</th>
								<td colspan="1"><input type="text" style="width: 100%"
									name="p_suzu" id="p_suzu" /></td>
								<th>발주</th>
								<td colspan="1"><input type="text" style="width: 100%"
									name="p_barzu" id="p_barzu" /></td>
							</tr>
							...
							<tr>
								<th>예상기한</th>
								<td colspan="1"><input type="text" style="width: 100%"
									name="p_deadline" id="p_deadline" /></td>
								<th>국내/해외</th>
								<td colspan="1"><input type="checkbox" name="p_country"
									id="p_country" value="국내">국내 <input type="checkbox"
									name="p_country" id="p_country" value="해외" checked="checked">해외</td>
							</tr>
